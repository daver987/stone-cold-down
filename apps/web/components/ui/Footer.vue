  ...
  <footer class="pt-10 bg-neutral-100 mb-[58px] md:mb-0" data-testid="footer">
    ...
    >
      <div
        ...
        :key="key"
        class="min-w-[25%] xs:min-w-[50%] flex flex-col"
      >
        <div
    ...
    <hr />
    <div
      class="py-10 md:flex md:mx-auto max-w-screen-3xl"
    ...
    <div class="bg-neutral-900" data-testid="section-bottom">
      <div
        class="justify-end px-4 py-10 md:flex md:py-6 max-w-screen-3xl mx-auto"
      >
