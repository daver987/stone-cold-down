...
<template>
  ...
  <h2
    class="hidden md:block typography-headline-4 font-bold mx-4 capitalize col-span-3"
  >
    ...
    <table class="hidden md:block text-left typography-text-sm mx-4">
      ...
      <thead class="border-b-2 border-neutral-200">
        <tr>
          ...
          <th class="lg:p-4 p-2 font-medium">
            {{ $t('account.ordersAndReturns.amount') }}
          </th>
          <th class="lg:p-4 p-2 font-medium">
            {{ $t('account.ordersAndReturns.status') }}
      ...
      <tbody>
        ...
        >
          <td class="lg:py-4 py-2 lg:pr-4 pr-2 lg:whitespace-nowrap">
            {{ id }}
          </td>
          ...
          <td
            :class="[
              'lg:p-4 p-2 ',
              { 'text-negative-700': status === 'Cancelled' },
            ]"
          >
            {{ status }}
          </td>
